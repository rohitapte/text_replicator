...
a,b,c=read_data_files("c:\\Users\\tihor\\Downloads\\tensorflow-rnn-shakespeare-master\\shakespeare\\*.txt",validation=False)
count=0
for x,y,e in rnn_minibatch_sequencer(a,200,30,2):
    for i in range(x.shape[0]):
        print(decode_to_text(x[i,:].tolist()))
        print("--------")
        if i>4: break
    print("#############################")
    count += 1
